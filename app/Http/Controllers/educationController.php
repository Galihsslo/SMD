...
class educationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.education.index')->with('data', $data); //mengeluarkan data riwayat
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Data education berhasil ubah');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Data berhasil di Hapus');
    }
}
